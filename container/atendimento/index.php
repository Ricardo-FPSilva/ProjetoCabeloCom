        ...
        <div class="cartao-registro">
            ...
            <form id="form-cliente" class="formulario-registro">
                <div>
                    ...
                    <input type="text" id="nome-cliente" name="clientName" class="campo-entrada"
                        placeholder="Nome Completo" required>
                </div>
                <div>
                    <label for="procedimento-cliente" class="rotulo-campo">Procedimento</label>
                    <input type="text" id="procedimento-cliente" name="clientProcedure" class="campo-entrada"
                        placeholder="Corte, Manicure, etc." required>
                </div>
                <div>
        ...
        <div class="cartao-registro">
            ...
            <form id="form-profissional" class="formulario-registro">
                <div>
                    ...
                    <input type="text" id="nome-profissional" name="professionalName" class="campo-entrada"
